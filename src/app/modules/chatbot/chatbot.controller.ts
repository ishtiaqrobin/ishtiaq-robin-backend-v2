...
const getAiProviderConfig = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const upsertAiProviderConfig = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const getChatbotConfig = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const upsertChatbotConfig = async (req: Request, res: Response, next: NextFunction) => {
  try {
